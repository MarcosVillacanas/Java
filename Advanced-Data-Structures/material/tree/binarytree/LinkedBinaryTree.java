...
public class LinkedBinaryTree<E> implements BinaryTree<E> {
    ...
    protected class BTNode<T> implements Position<T> {
        ...
        public final void setElement(T o) { element = o; }

        public final BTNode<T> getLeft() { return left; }

        public final void setLeft(BTNode<T> v) { left = v; }

        public final BTNode<T> getRight() { return right; }

        public final void setRight(BTNode<T> v) { right = v; }

        public final BTNode<T> getParent() { return parent; }

        public final void setParent(BTNode<T> v) { parent = v; }
    }
    ...
    @Override
    public boolean isLeaf(Position<E> p) { return !isInternal(p); }
    ...
    public Position<E> sibling(Position<E> p) throws RuntimeException {
        ...
        if (parent != null && (this.hasLeft(parent) || this.hasRight(parent))) {
    ...
    public E remove(Position<E> p) throws RuntimeException {
        ...
        if (leftPos != null && rightPos != null)
            throw new RuntimeException("Can't delete a node with two children");
