...
//		}
    ...
    public Iterable<Position<E>> successors(Position<E> pos){
        Iterable<Position<RBInfo<E>>> it = this.bst.successors(this.checkPosition(pos).getTreePosition());
    ...
    public Iterable<Position<E>> predecessors(Position<E> pos){
		Iterable<Position<RBInfo<E>>> it = this.bst.predecessors(this.checkPosition(pos).getTreePosition());
		List<Position<E>> l = new LinkedList<>();
		it.forEach(p -> l.add(p.getElement()));
		return l;
    }
    ...
    public Iterable<Position<E>> inOrderTraversal () {
        Iterable<Position<RBInfo<E>>> it = this.bst.inOrderTraversal();
        List<Position<E>> l = new LinkedList<>();
        it.forEach(o -> l.add(o.getElement()));
        return l;
    }
