...
public class AVLTree<E> implements BinarySearchTree<E> {
    ...
    public Iterable<Position<E>> successors(Position<E> pos){
        Iterable<Position<AVLInfo<E>>> it = this.bst.successors(this.checkPosition(pos).getTreePosition());
        List<Position<E>> l = new LinkedList<>();
        it.forEach(p -> l.add(p.getElement()));
        return l;
    }
    public Iterable<Position<E>> predecessors(Position<E> pos){
        Iterable<Position<AVLInfo<E>>> it = this.bst.predecessors(this.checkPosition(pos).getTreePosition());
        List<Position<E>> l = new LinkedList<>();
        it.forEach(p -> l.add(p.getElement()));
        return l;
    }
    ...
    public Iterable<Position<E>> inOrderTraversal () {
        Iterable<Position<AVLInfo<E>>> ite = this.bst.inOrderTraversal();
        List<Position<E>> l = new LinkedList<>();
        ite.forEach(o -> l.add(o.getElement()));
        return l;
    }
}